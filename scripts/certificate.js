...
function createCourseCard(filteredCourses) {
    ...
    displayCredits(filteredCourses);

};

function displayCredits(filteredCourses) {
    const credits = filteredCourses.reduce((sum, course) => sum + course.credits, 0);
    document.querySelector("#credits").textContent = `The total credits for the course(s) listed above is ${credits}.`;
}
